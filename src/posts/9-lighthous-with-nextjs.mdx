...
import PostUtil from "../utils/postUtil"; import Caption from "../components/mdx/Caption"; import Link
...
<Caption><Link href={'https://web.dev/apply-instant-loading-with-prpl/'}>이미지 출처</Link></Caption>
