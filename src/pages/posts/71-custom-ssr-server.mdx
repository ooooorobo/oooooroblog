...
> 어떤 서비스인지 궁금하다면? [데모 확인하기](https://www.bandalart.co/share/Ha63U)
>

웹 공유 링크를 구현하기 위해, 웹 서버는 공유 키가 포함된 url로 GET 요청을 받으면, 이 공유 키에 대한 실제 표 데이터를 API 서버에서 받아와야 하고, 반다라트 표를 보여줄 수 있는 HTML을 응답으로 보내줘야 한다.
